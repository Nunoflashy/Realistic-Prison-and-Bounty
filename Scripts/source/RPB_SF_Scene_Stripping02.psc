...
Function Fragment_9()
;BEGIN CODE
self.SendModEvent("RPB_ScenePlayingEnd", "RPB_Stripping02", 2)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
self.SendModEvent("RPB_ScenePlayingStart", "RPB_Stripping02", 2)
;END CODE
EndFunction
;END FRAGMENT
...
;BEGIN CODE
self.SendModEvent("RPB_ScenePlayingStart", "RPB_Stripping02", 6)
;END CODE
EndFunction
;END FRAGMENT
